...
{
    public class SirenOutputFormatterEncodingAndSerializationSettingTests
        : SirenOutputFormatterTestsBase<StartUpEncodingAndSerializationSetting>
    {
        [Fact]
    ...
    public class StartUpEncodingAndSerializationSetting
    {
